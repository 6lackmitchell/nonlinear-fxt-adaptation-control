...
Loads parameters and functions for the quadrotor/dynamic_6dof arbitrary_disturbance situation.
...
if platform.machine() == "aarch64":
    ...
    save_path = "/Users/mblack/Documents/git/nonlinear-fxt-adaptation-control/data/quadrotor/dynamic_6dof/arbitrary_disturbance/test.pkl"

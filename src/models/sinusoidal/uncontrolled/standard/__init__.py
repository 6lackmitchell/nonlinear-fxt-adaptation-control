...
if platform.machine() == "aarch64":
    ...
    save_path = "/Users/mblack/Documents/git/nonlinear-fxt-adaptation-control/data/sinusoidal/uncontrolled/standard/test.pkl"
...
cbf_controlled_agents = [
    Agent(i, z0[i, :], u0, [], time, step_dynamics, fxt_adaptation_cbf_qp_controller(i), save_path)
    for i in range(1)
]
human_agents = []
